...
class Network(object):
    ...
    def test(self, X_test, y_test):
        ...
        plt.xlabel('True')
        plt.ylabel('Predict')
        plt.savefig('Save_png/6.png', format='png', dpi=300)
        plt.show()
...
class NNGeneticAlgo:
    ...
    def print_test(self, X_test, y_test):
        ...
        return initial_biases, initial_weight
class my_network():
    def __init__(self, initial_biases,initial_weight,X, y, X_test, y_test, X_val, y_val, X_train, y_train, num_neural_hid_layer_1, num_neural_hid_layer_2):
        self.X = X
        self.y = y
        ...
        self.n1 = num_neural_hid_layer_1
        self.n2 = num_neural_hid_layer_2
    ...
    def ANN(self):
        ...
        model.add(tf.keras.layers.Dense(self.n1, input_dim=5, use_bias=True, activation='sigmoid'))
    ...
    def train_ANN(self):
        ...
        plt.xlabel('True')
        plt.ylabel('Predict')
        plt.savefig('Save_png/7.png', format='png', dpi=300)
        plt.show()
        ...
        plt.xlabel('True')
        plt.ylabel('Predict')
        plt.savefig('Save_png/8.png', format='png', dpi=300)
        plt.show()
        ...
        plt.savefig('Save_png/9.png', format='png', dpi=300)
        plt.show()
        ...
        plt.savefig('Save_png/10.png', format='png', dpi=120)
        plt.show()
...
def main(num_neural_hid_layer_1, num_neural_hid_layer_2):
    # load data
    df = pd.read_csv('Do_sut_2.csv')
    # df.info()
    # print(df.describe())
    # print(df.isnull().sum())
    ...
    # parameters
    N_POPS = 20
    NET_SIZE = [5, num_neural_hid_layer_1, num_neural_hid_layer_2, 1]
    MUTATION_RATE = 0.1
    CROSSOVER_RATE = 0.4
    RETAIN_RATE = 0.4
    ...
    print("====================================")
    ann = my_network(initial_biases, initial_weight, X, y, X_test, y_test, X_val, y_val, X_train, y_train, num_neural_hid_layer_1, num_neural_hid_layer_2)
    ann.train_ANN()
